 ...
 //      $(".nav").append('<li class="nav-item"><a (click)="logout($event)" href="" class="upload sign"><span>  <i style="color:#011835;font-size: 25px;" class="fa fa-sign-out fa-lg"></i>  </span></a></li>');
 //  }
